...
<head>
  <meta charset="UTF-8">
  <title>Enterprise-SaaS — Active Workspace</title>
...
<body class="bg-slate-950 text-slate-100 min-h-screen flex items-center justify-center p-6">
  <div class="max-w-lg w-full bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl text-center space-y-4">
    ...
    <h1 class="text-2xl font-bold">Enterprise-SaaS</h1>
    <p class="text-xs text-emerald-400 font-medium">? Embedded Backend & API Active (Port 8083)</p>
